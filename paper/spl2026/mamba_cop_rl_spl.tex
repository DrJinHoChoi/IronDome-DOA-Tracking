...
\begin{table}[t]
  \centering
  \caption{Overall mean GOSPA and model size ($\downarrow$ better).}
  \label{tab:overall}
  \footnotesize
...
\begin{table}[t]
  \centering
  \caption{SSM hidden state dimension $d_s$ sensitivity
           (183-dim, $T{=}200$, 50 seeds). \textbf{Bold} = best.}
  \label{tab:dstate}
  \footnotesize
  ...
  \begin{tabular}{ccccc}
    ...
    \midrule
    8  & $.228{\pm}.022$ & $-1.9$ & 28\,K & 27.3 \\
    16 & $.220{\pm}.018$ & $-2.0$ & 35\,K & 34.2 \\
    24 & $\mathbf{.213}{\pm}.014$ & $\mathbf{-5.1}$ & 42\,K & 41.4 \\
    32 & $.214{\pm}.015$ & $-4.5$ & 51\,K & 49.8 \\
    \bottomrule
  \end{tabular}
\end{table}
