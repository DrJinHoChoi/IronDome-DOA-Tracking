...
front-end driving a \emph{physics-based} $\delta$-GLMB back-end, robust across
source count, SNR, motion, and signal type. The principal contributions are:
...
open-loop estimate. The recommended deployed configuration is a gated COP
front-end driving a physics-based $\delta$-GLMB back-end.}
\label{fig:system}
\end{figure*}
...
driving a physics-based $\delta$-GLMB back-end}: agnostic in both estimator and
tracker, gated for safety, and matched to the target dynamics.
