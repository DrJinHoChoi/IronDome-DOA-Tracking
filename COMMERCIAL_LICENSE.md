# Commercial License — IronDome-DOA-Tracking
...
- Integration into one commercial product line.
...
- Optional sublicensing to downstream OEMs.
- Custom terms.
...
> Subject line: `[IronDome-DOA-Tracking Commercial License] <your organization>`

Please include in your first email:
1. Organization name and country of incorporation.
2. Intended use case (product, internal tool, defense, research, etc.).
3. Deployment scale (units / users / sites).
4. Timeline (evaluation start, production launch).
5. Whether hardware (FPGA/ASIC/MCU) is involved.
